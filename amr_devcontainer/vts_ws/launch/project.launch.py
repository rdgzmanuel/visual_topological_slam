...
def generate_launch_description() -> LaunchDescription:
    ...
    assert loss in ["contrastive", "triplet"]
    ...
    # start_1: tuple[float, float, float] = (0.46, -0.02, -0.11)
    # trajectory_1: str = "cold-freiburg_part_b_seq3_cloudy3"
    # start_2: tuple[float, float, float] = (0.29, 0.0, 0.0)
    # trajectory_2: str = "cold-freiburg_part_b_seq3_sunny1"
    ...
    # start_1: tuple[float, float, float] = (0.27, 0.00, 0.00)
            ...
            parameters=[
                {
                    "start_1": start_1,
                    "start_2": start_2,
                    "world_limits": settings[lab]["world_limits"],
                    "map_name": settings[lab]["map_name"],
                    "origin": settings[lab]["origin"],
                    "weights": settings[lab]["weights"],
                    "trajectory_1": trajectory_1,
                    "ext_rewiring": settings[lab]["ext_rewiring"],
